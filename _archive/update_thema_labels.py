#!/usr/bin/env python3
"""
Script om thema labels toe te voegen aan alle begrippen in begrippen.html
"""
...
# Print alle begrippen met hun thema's
print("Begrippen en hun thema's:")
for begrip, thema in thema_mapping.items():
    print(f"{begrip}: {thema}")

print(f"\nTotaal begrippen: {len(thema_mapping)}")
