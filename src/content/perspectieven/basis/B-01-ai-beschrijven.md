...
{% task %}
**Wat denk jij dat AI is?**
Welke van de onderstaande omschrijvingen komt het dichtst bij wat jij denkt dat AI betekent?
...
{% info %}
**Alle drie de opties zijn eigenlijk gedeeltelijk waar, maar ook gedeeltelijk onjuist.**
Dit laat precies zien waarom het omschrijven van AI zo ingewikkeld is.
...
{% info %}
Er zijn verschillende redenen waarom het lastig is om AI eenduidig te omschrijven:
{% endinfo %}

{% trivia %}
<details>
<summary><strong>Het is al lastig om menselijke intelligentie duidelijk uit te leggen</strong> (klik om te lezen)</summary>
...
{% trivia %}
<details>
<summary><strong>De voorwaarden om iets 'intelligent' te noemen verschuiven voortdurend</strong> (klik om te lezen)</summary>
...
{% trivia %}
<details>
<summary><strong>Beleidsmakers hebben over het algemeen onvoldoende basiskennis over AI</strong> (klik om te lezen)</summary>
...
{% trivia %}
<details>
<summary><strong>AI Washing: Bedrijven overdrijven over het gebruik van AI</strong> (klik om te lezen)</summary>

Bedrijven overdrijven of zijn misleidend over het gebruik van AI in hun producten om aantrekkelijker of innovatiever over te komen dan het werkelijk is. Dit staat ook wel bekend als [AI washing](/artikelen/begrippen/#ai-washing). Hierdoor vervaagt de technische betekenis van AI, wordt AI zowel onder- als overhyped, verandert het in een leeg buzzword en daalt uiteindelijk het vertrouwen in echte toepassingen.

In september 2023 lanceerde Coca&#8209;Cola de "Y3000", een drankje dat volgens de marketing "co&#8209;created with human and artificial intelligence" zou zijn. Kritiek kwam omdat Coca&#8209;Cola nooit duidelijk maakte wat de rol van AI precies was -- de bewering lijkt vooral bedoeld om de innovatiegerichte aantrekkingskracht te verhogen.

*Bron: [CTO Magazine](https://ctomagazine.com/what-is-ai-washing-why-it-is-a-problem/)*
</details>
{% endtrivia %}
...
Waarom? Zonder gedeeld begrip van wat AI precies is, kunnen we er niet helder over praten. En zonder die helderheid wordt het bijna onmogelijk om AI goed te [reguleren](/artikelen/begrippen/#reguleren). Dat kan leiden tot maatschappelijke problemen, of juist innovatie in de weg zitten.
{% endinfo %}

{% trivia %}
<details>
<summary><strong>De EU AI Act en praktische gevolgen</strong> (klik om te lezen)</summary>

De [EU AI Act](/artikelen/begrippen/#eu-ai-act) ziet AI ruim. Daardoor vallen soms ook simpele 'regelsystemen' onder de wet. Afhankelijk van het risico komen er extra eisen bij. Voor jou als klant betekent dit twee dingen. Je ziet wanneer AI wordt gebruikt (bijvoorbeeld een label bij een chatbot of AI&#8209;beeld). En krijg je een besluit dat je raakt, zoals een kredietaanvraag, dan staat erbij welke gegevens zijn gebruikt en kun je een mens om herbeoordeling vragen. Die extra zekerheid kost organisaties geld en tijd, wat soms terugkomt in de prijs of premie.
</details>
{% endtrivia %}
...
{% info %}
In het artikel ['Defining Artificial Intelligence'](https://papers.ssrn.com/sol3/papers.cfm?abstract_id=5154389) van 2025 onderzoekt Weitzel bestaande definities en hun tekortkomingen. Op basis daarvan stelt hij een betere omschrijving voor, al benadrukt hij dat AI nooit volledig in &eacute;&eacute;n perfecte definitie te vangen is. De volgende definitie ziet hij dan ook als een verbetering ten opzichte van de definities die hij heeft geanalyseerd:
...
Door te zeggen dat het om [machine learning](/artikelen/begrippen/#machine-learning) gaat, worden regelgebaseerde AI-modellen uitgesloten en niet iedere expert zal het daarom eens zijn met Weitzels definitie.
...
{% info %}
Binnen AI worden verschillende [AI-modellen](/artikelen/begrippen/#ai-model) en [AI-methoden](/artikelen/begrippen/#ai-methode) gebruikt.
In de populaire media, marketing en publieke discussie ontstaat er verwarring over deze begrippen doordat ze op &eacute;&eacute;n hoop worden gegooid. Dit leidt tot "misverstanden over de AI-capaciteiten en -beperkingen" [Stanford AI Index Report (2024)](https://aiindex.stanford.edu/report/).

We zullen daarom deze begrippen hieronder verhelderen:
{% endinfo %}

{% info %}
**Een AI-model** is het rekenkundige "brein" dat getraind is om een taak uit te voeren. Een voorbeeld van zo'n model is GPT-5. Dit is een AI-model dat spraak, tekst en afbeeldingen kan herkennen en cre&euml;ren (genereren).
...
{% trivia %}
<details>
<summary><strong>Europese AI in de spotlight: Mistral</strong> (klik om te lezen)</summary>
...
{% trivia %}
<details>
<summary><strong>MYCIN: Een voorbeeld van regelgebaseerd AI</strong> (klik om te lezen)</summary>

Een voorbeeld van zo'n regelgebaseerd AI-model is [MYCIN](/artikelen/begrippen/#mycin), een expertsysteem uit de jaren '70 dat artsen ondersteunde bij diagnoses en antibiotica-adviezen. Het gebruikte zo'n 600 regels en redeneerde via [backward chaining](/artikelen/begrippen/#backward-chaining). Destijds gold het als AI, omdat het beslissingen nam, zijn redenering kon uitleggen en vaak net zo goed presteerde als menselijke artsen.
</details>
{% endtrivia %}
...
De combinatie van regelgebaseerd en data-gedreven wordt ook wel [hybride AI](/artikelen/begrippen/#hybride-ai) genoemd. In de praktijk werken veel modellen zo: regels en menselijk ontwerp bieden controle en uitlegbaarheid; leren uit data zorgt voor flexibiliteit en prestaties.
{% endinfo %}

{% trivia %}
<details>
<summary><strong>AlphaGo: Een voorbeeld van hybride AI</strong> (klik om te lezen)</summary>
...
{% quiz "Quizvraag: Regelgebaseerde vs data-gedreven" %}
Een arts gebruikt een computerprogramma om te bepalen of een pati&euml;nt een bepaalde ziekte heeft. Het programma:

1. Stelt vragen over symptomen (koorts, pijn, etc.),
2. Leert niet bij van nieuwe pati&euml;ntgegevens,
3. Gebruikt 500 medische regels zoals "ALS koorts > 38&deg;C EN pijn in onderbuik DAN mogelijk blindedarmontsteking",
...
<div class="quiz-option" onclick="toggleAnswer('A1')">
<strong>A)</strong> Data-gedreven
<div class="answer-feedback" id="answer-A1">
<div class="feedback-content">
<span class="feedback-icon">&#10060;</span>
<strong>Nog niet goed!</strong><br>
<em>Hint:</em> Het programma leert niet bij van nieuwe gegevens en gebruikt vaste regels. Denk aan wat dit betekent voor de methode.
</div>
</div>
</div>
<div class="quiz-option" onclick="toggleAnswer('B1')">
<strong>B)</strong> Regelgebaseerd
<div class="answer-feedback" id="answer-B1">
<div class="feedback-content">
<span class="feedback-icon">&#9989;</span>
<strong>Correct!</strong><br>
Dit is inderdaad een regelgebaseerd systeem. Het gebruikt vooraf vastgelegde regels (de 500 medische regels) en leert niet bij van nieuwe data. Het systeem volgt een vaste logica zonder zich aan te passen aan nieuwe informatie.
</div>
</div>
</div>
<div class="quiz-option" onclick="toggleAnswer('C1')">
<strong>C)</strong> Hybride
<div class="answer-feedback" id="answer-C1">
<div class="feedback-content">
<span class="feedback-icon">&#10060;</span>
<strong>Nog niet goed!</strong><br>
<em>Hint:</em> Een hybride systeem combineert regelgebaseerde en data-gedreven elementen. Dit systeem gebruikt alleen regels en leert niet bij.
</div>
</div>
</div>
<div class="quiz-option" onclick="toggleAnswer('D1')">
<strong>D)</strong> Geen van allemaal
<div class="answer-feedback" id="answer-D1">
<div class="feedback-content">
<span class="feedback-icon">&#10060;</span>
<strong>Nog niet goed!</strong><br>
<em>Hint:</em> Dit is wel degelijk een van de genoemde methoden. Kijk nog eens naar de kenmerken van het systeem.
</div>
</div>
</div>
</div>
...
Het idee dat AI in staat is om allerlei taken uit te voeren die het menselijk vermogen evenaren wordt *Artificial General Intelligence (AGI)* genoemd.
...
{% trivia %}
<details>
<summary><strong>Weak AI vs Strong AI: De termen van John Searle</strong> (klik om te lezen)</summary>

In de jaren 1980 introduceerde de filosoof John Searle, de termen [Weak AI](/artikelen/begrippen/#weak-ai) en [Strong AI](/artikelen/begrippen/#strong-ai)
...
Daarom gebruiken veel onderzoekers tegenwoordig liever de termen [narrow AI](/artikelen/begrippen/#narrow-ai) (AI die specifieke taken kan uitvoeren) en [general AI](/artikelen/begrippen/#general-ai) (AI die taken kan uitvoeren zoals een mens).
</details>
{% endtrivia %}
...
{% info %}
Een andere manier om naar AI-modellen te kijken is het verschil in type.

**Discriminatieve AI:** Dit type AI is ontworpen om onderscheid te maken tussen verschillende categorie&euml;n. Bijvoorbeeld: is deze afbeelding een kat of een hond? Het model leert van voorbeelden en probeert de juiste categorie te voorspellen. Dit soort AI wordt veel gebruikt in toepassingen zoals spamfilters, gezichtsherkenning en medische diagnoses.
...
Het verschil tussen discriminatieve en generatieve AI laat zien hoe AI zich heeft ontwikkeld. Waar discriminatieve AI vooral helpt bij het oplossen van specifieke problemen, zoals het herkennen van objecten of het voorspellen van trends, biedt generatieve AI de mogelijkheid om nieuwe idee&euml;n en oplossingen te cre&euml;ren. Dit maakt generatieve AI een krachtig hulpmiddel in veel verschillende domeinen, van kunst en entertainment tot wetenschap en technologie.
{% endinfo %}
...
Je hebt nu een beter begrip van waarom het zo moeilijk is om AI eenduidig te defini&euml;ren. We hebben gezien dat:

**AI-definitie is complex** - Er zijn verschillende redenen waarom het lastig is om AI helder te omschrijven: menselijke intelligentie is al moeilijk te defini&euml;ren, de criteria verschuiven voortdurend, beleidsmakers hebben onvoldoende kennis, en AI washing vervaagt de betekenis.

**Verschillende invalshoeken** - We kunnen AI bekijken vanuit verschillende perspectieven:
- *Methode:* Regelgebaseerd vs data-gedreven (of hybride)
- *Reikwijdte:* Narrow AI vs AGI vs ASI
- *Type:* Discriminatief vs generatief

**Praktische gevolgen** - Zonder duidelijke definities wordt het moeilijk om AI goed te reguleren en te begrijpen. Dit kan leiden tot maatschappelijke problemen of innovatie in de weg zitten.

**Volgende stappen:**
In het volgende artikel gaan we dieper in op de kernbegrippen van AI en de ontwikkeling die heeft geleid tot de AI van vandaag.
{% endconclusion %}
