...
- **TruthfulQA**: Test hoe goed AI-modellen feitelijke vragen kunnen beantwoorden zonder te [hallucineren](/artikelen/begrippen/#hallucineren)
...
Voor de complete AI-applicaties (zoals [ChatGPT](/artikelen/begrippen/#chatgpt), Claude, Lumo) zijn er ook vergelijkingen beschikbaar:
...
### Top-tier tools:
- **[ChatGPT](/artikelen/begrippen/#chatgpt) Plus** ([OpenAI](/artikelen/begrippen/#openai)) - draait op GPT-4 Turbo, een van de meest krachtige modellen
...
- **Wil je snel een antwoord?** &rarr; Gebruik een chatbot zoals [ChatGPT](/artikelen/begrippen/#chatgpt) of Lumo
- **Wil je privacy beschermen?** &rarr; Kies voor tools met ghost mode of lokale AI
- **Wil je betrouwbare informatie?** &rarr; Combineer AI met web search en verificatie
- **Wil je creatief zijn?** &rarr; Experimenteer met generatieve AI voor tekst, beeld of audio
- **Wil je effici&euml;nt werken?** &rarr; Gebruik AI als hulpmiddel, niet als vervanging
...
Of het genereren van een filmpje waarin Will Smith spaghetti eet &ndash; een voorbeeld dat in 2023 viraal ging, maar waarvan de kwaliteit inmiddels sterk verouderd is vergeleken met wat AI-applicaties nu kunnen ([Wikipedia: Will Smith eating spaghetti](https://en.wikipedia.org/wiki/Will_Smith_eating_spaghetti)).
...
AI-applicaties zijn er in vele vormen, van geavanceerde systemen die complexe taken uitvoeren tot eenvoudige tools die &eacute;&eacute;n specifieke functie vervullen. Het Stanford AI Index Report 2024 benadrukt dat AI wordt toegepast in uiteenlopende sectoren en toepassingen, vari&euml;rend van generatieve AI voor tekst en beeld tot gespecialiseerde medische, juridische en educatieve systemen ([Stanford University, 2024](https://aiindex.stanford.edu/report/)).
...
- **Financi&euml;le sector**: Banken gebruiken AI om fraude op te sporen en om klanten sneller en slimmer te helpen via chatbots.
...
AI-applicaties zijn ontzettend veelzijdig en kunnen je helpen met allerlei taken. Hier zijn de belangrijkste categorie&euml;n:

## **Tekst en schrijven**
- **Samenvattingen maken** van lange documenten, artikelen of boeken
    - *Beste tools:* Claude 3.5 Sonnet, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus (GPT-4), Perplexity Pro
- **Teksten herschrijven** in verschillende stijlen (formeel, informeel, creatief)
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Jasper AI
- **Vertalingen** tussen talen
    - *Beste tools:* DeepL, Google Translate, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus
- **Content genereren** voor blogs, social media of presentaties
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Copy.ai, Jasper AI
- **E-mails opstellen** en beantwoorden
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Grammarly
- **Scripts schrijven** voor video's of podcasts
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Sudowrite

## **Code en programmeren**
- **Code schrijven** in verschillende programmeertalen
    - *Beste tools:* GitHub Copilot, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Cursor AI
- **Bugs oplossen** en code debuggen
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, GitHub Copilot
- **Code uitleggen** en documenteren
    - *Beste tools:* Claude 3.5 Sonnet, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, GitHub Copilot
- **Websites bouwen** met HTML, CSS en JavaScript
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, GitHub Copilot, 10Web
- **Apps ontwikkelen** en automatiseren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, GitHub Copilot, Bubble
...
- **Spreadsheets analyseren** en patronen ontdekken
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Microsoft Excel AI, Google Sheets AI
- **Rapporten maken** op basis van data
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Perplexity Pro, Tableau AI
- **Grafieken en visualisaties** genereren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Tableau AI, Power BI
- **Onderzoek doen** en bronnen samenvatten
    - *Beste tools:* Perplexity Pro, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Consensus
- **Statistieken berekenen** en interpreteren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Wolfram Alpha, SPSS

## **Creativiteit en entertainment**
- **Verhalen schrijven** en plotlijnen ontwikkelen
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Sudowrite, NovelAI
- **Po&euml;zie en liedjes** componeren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, AIVA, Amper Music
- **Brainstormen** en idee&euml;n genereren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Miro AI, Notion AI
- **Spellen ontwerpen** en puzzels maken
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Unity AI, GameMaker Studio
- **Kunst en muziek** cre&euml;ren
...
- **Planning en organisatie** van taken en projecten
    - *Beste tools:* Notion AI, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Asana AI
- **Notulen maken** van vergaderingen
    - *Beste tools:* Otter.ai, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Fireflies.ai
- **Presentaties voorbereiden** en structureren
    - *Beste tools:* Beautiful.ai, Gamma, Tome, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet
- **Onderzoek doen** en bronnen vinden
    - *Beste tools:* Perplexity Pro, [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Consensus
- **Klantenservice** en support automatiseren
    - *Beste tools:* [ChatGPT](/artikelen/begrippen/#chatgpt) Plus, Claude 3.5 Sonnet, Intercom, Zendesk AI
...
## Kwaliteit
- **Controleer output**: AI kan fouten maken, [hallucineren](/artikelen/begrippen/#hallucineren) of onjuiste informatie geven &ndash; verifieer altijd belangrijke feiten.

## Veiligheid
- **Klik geen verdachte links aan**: AI kan links genereren die mogelijk schadelijk zijn of naar malware leiden

## Ethisch gebruik
- **Respecteer auteursrechten**: Gebruik AI niet om beschermd materiaal te kopi&euml;ren of te imiteren
...
1. **Ga naar [ChatGPT](/artikelen/begrippen/#chatgpt) ([website](https://chat.openai.com/)) of [Claude](https://claude.ai/)**
...
{% trivia %}
**Tip**: Gebruik deze opdracht om de vuistregels die je net hebt geleerd in praktijk te brengen. Deel geen persoonlijke informatie en controleer wat de AI zegt!
{% endtrivia %}
...
Deze sectie is nog in ontwikkeling...
